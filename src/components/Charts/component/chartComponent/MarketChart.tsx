...
export type MarketChartPropsType = {
  data: dataChartType
}

const MarketChart: React.FC<MarketChartPropsType> = ({ data }) => {
  ...
  return (
    <div>
      <ReactECharts option={option} style={{ height: '600px', width: '100%' }} lazyUpdate={true} />
    </div>
  )
}
